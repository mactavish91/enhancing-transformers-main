...
class ViTVQ(pl.LightningModule):
    ...
    def configure_optimizers(self) -> Tuple[List, List]:
        ...
        # schedulers = [get_cosine_schedule_with_warmup(
        #     optimizer, num_warmup_steps=0.02*self.trainer.max_steps, num_training_steps=self.trainer.max_steps,
        # ) for optimizer in optimizers]
    ...
    def log_images(self, batch: Tuple[Any, Any], *args, **kwargs) -> Dict:
        ...
        # log["originals"] = self.unnormalize(x)
        # log["reconstructions"] = self.unnormalize(self.decode(quant))
        log["originals"] = x
